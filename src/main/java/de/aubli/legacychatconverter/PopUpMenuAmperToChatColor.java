...
/**
 * @author AlexMl Created on 20.01.22 for LegacyChatConverter
 */
public class PopUpMenuAmperToChatColor extends AnAction {
    ...
    public void actionPerformed(@NotNull final AnActionEvent e) {
        ...
        WriteCommandAction.runWriteCommandAction(project, "Ampersand Replace", "LegacyChatConverter",
    ...
    private Runnable replace(Caret caret, Document document) {
        ...
        return () -> {
            String newText = Converter.convertAmpersandToChatColor(caret.getSelectedText());
